...
<body>
   ...
   <?php
    ...
    $waktu  = gmdate("Y-m-d H:i:s", time()+60*60*7);
       ...
       $query1 = "INSERT INTO tb_download (nama, no_hp, alamat, email,  tanggal_download) values ('$nama','$no_hp','$alamat','$email', '$waktu')";
       $result1 = mysqli_query($koneksi,$query1) or die ("Kesalahan Penginputan");
     

       echo '<script language="javascript">alert("Terimakasih...");
       document.location="../CV. Best Advertising Purwokerto.pdf"</script>';
